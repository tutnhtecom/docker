...
$this->title = 'Danh mục lĩnh vực hoạt động';
...
<div class="nhommau-index">
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    Html::a('<i class="glyphicon glyphicon-plus"></i> Thêm lĩnh vực hoạt động', ['danh-muc/tao-linh-vuc-hoat-dong'],
                        ['role'=>'modal-remote','title'=> 'Thêm mới lĩnh vực hoạt động','class'=>'btn btn-primary'])
                ],
            ],
            'striped' => true,
            'condensed' => true,
            ...
            'panel' => [
                'type' => 'primary',
                'heading' => '<i class="glyphicon glyphicon-list"></i> Danh sách lĩnh vực hoạt động',
                'after' => false,
                'showFooter' => false,
            ]
        ])?>
