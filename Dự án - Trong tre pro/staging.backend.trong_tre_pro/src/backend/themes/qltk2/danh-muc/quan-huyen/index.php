...
$this->title = 'Danh mục quận huyện';
...
<div class="nhommau-index">
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    Html::a('<i class="glyphicon glyphicon-plus"></i> Thêm quận huyện', ['danh-muc/them-quan-huyen'],
            ...
            'panel' => [
                'type' => 'primary',
                'heading' => '<i class="glyphicon glyphicon-list"></i> Danh sách quận huyện',
                'after' => false,
                'showFooter' => false,
            ]
        ])?>
