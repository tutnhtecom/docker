...
$this->title = 'Danh mục xếp loại hội viên';
...
<div class="nhommau-index">
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    Html::a('<i class="glyphicon glyphicon-plus"></i> Thêm xếp loại', ['danh-muc/tao-xep-loai-hoi-vien'],
                        ['role'=>'modal-remote','title'=> 'Thêm mới xếp loại','class'=>'btn btn-primary'])
                ],
            ],
            'striped' => true,
            'condensed' => true,
            ...
            'panel' => [
                'type' => 'primary',
                'heading' => '<i class="glyphicon glyphicon-list"></i> Danh sách xếp loại',
                'after' => false,
                'showFooter' => false,
            ]
        ])?>
