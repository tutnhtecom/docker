...
<div class="nhommau-index">
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    Html::a('<i class="glyphicon glyphicon-plus"></i> Thêm đường phố', ['danh-muc/them-duong-pho'],
            ...
            'panel' => [
                'type' => 'primary',
                'heading' => '<i class="glyphicon glyphicon-list"></i> Danh sách đường phố',
                'after' => false,
                'showFooter' => false,
            ]
        ])?>
